...
bool WebHandlerClientData::handleGet(CivetServer *server, struct mg_connection *conn)
{
...
std::string WebHandlerClientData::getFileNameFromPath(const struct mg_request_info* req_info) {
...
bool WebHandlerClientData::handlePost(CivetServer *server, struct mg_connection *conn) {
...
bool WebHandlerClientData::handGet_json(CivetServer* server, struct mg_connection* conn, const struct mg_request_info* req_info, const std::string baseFilename) {
...
bool WebHandlerClientData::handGet_test(CivetServer* server, struct mg_connection* conn, const struct mg_request_info* req_info) {
    char valBuffer[255];
    int result = -1;
